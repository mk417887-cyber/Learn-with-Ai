    ...
    const renderMessage = (msg, index) => {
        ...
        return (
            <div key={index} className={`flex items-start gap-3 my-4 ${isUser ? 'justify-end' : ' '}`}>
                ...
                {isUser && (
                    <div className='w-9 h-9 rounded-xl bg-linear-to-br from-slate-200 to-slate-300 shadow-lg shadow-emerald-500/25 text-slate-700 font-semibold text-sm flex items-center justify-center shrink-0'>
            ...
            <div className="p-5 border-t border-slate-200/60 bg-white/80">
                <form onSubmit={handleSendMessage} className="flex items-center gap-3 ">
                    ...
                    <button
                        ...
                        className="shrink-0 w-12 h-12 bg-linear-to-r from-emerald-500 to-teal-500 text-white rounded-xl flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 active:scale-[0.98]"
                    >
