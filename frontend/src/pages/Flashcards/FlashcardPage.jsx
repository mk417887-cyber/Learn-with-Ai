...
const FlashcardPage = ({ flashcardSet }) => {
    ...
    <div>
      <div className="mb-4">
        <Link
          ...
          className="inline-flex items-center gap-2 text-sm font-semibold text-neutral-700 hover:text-slate-900 transition-colors duration-200"
        >
          <ArrowLeft size={16} />
          Back to Document
        </Link>
