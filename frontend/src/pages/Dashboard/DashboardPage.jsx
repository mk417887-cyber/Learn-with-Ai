...
//                 <stat.icon className='w-5 h-5 text-white' strokeWidth={2}></stat.icon>
//               </div>
//             </div><div className="text-3xl font-semibold text-slate-900 tracking-tight">
//               {stat.value}
//             </div>
//           </div>
//         ))}
...
//                   className="group flex items-center justify-between p-4 rounded-xl bg-slate-50/50 border border-slate-200/60 hover:bg-white hover:border-slate-300/60  hover-shadow transition-colors duration-200"
//                 >
...
//                     <a
//                       href={activity.link}
//                       className="ml-4 px-4 py-2 text-xs font-semibold text-emerald-600 bg-white rounded-xl border border-slate-200 hover:bg-slate-50 hover:border-slate-300 transition-colors duration-200"
//                     >
//                       View
//                     </a>
//                   )}
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="group bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl p-6 flex items-center justify-between gap-4 hover:bg-white transition-colors duration-200 shadow-sm"
            >
              <div>
            ...
            <div className="space-y-3">
              {[
                ...
                .map((activity, index) => (
                  <div
                    key={activity.id || index}
                    className="group flex items-center justify-between p-4 rounded-xl bg-slate-50/50 border border-slate-200/60 hover:bg-white hover:border-slate-300/60 transition-colors duration-200"
                  >
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <div className={`w-2 h-2 rounded-full ${activity.type === 'document'
