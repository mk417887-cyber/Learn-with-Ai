        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50  p-10 ">
          ...
          <div className=" space-y-5">
            ...
            <button
              ...
              disabled={loading}
              className="group relative w-full h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 active:scale-[0.98] text-white rounded-xl flex justify-center items-center transition-colors duration-200 focus:outline-none focus:ring-4 focus:ring-emerald-500/20 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-linear-to-r disabled:hover:from-emerald-500 disabled:hover:to-teal-500 overflow-hidden"
            >
              ...
              <div className="absolute inset-0  bg-linear-to-r from-white/0 via-white/20  to-white/0 -translate-x-full group-hover:translate-x-full group-hover:opacity-100 transition-transition duration-200" />
            </button>
          </div>
          {/* Footer */}
