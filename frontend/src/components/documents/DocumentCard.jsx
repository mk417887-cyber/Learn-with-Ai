...
const DocumentCard = ({ document, onDelete }) => {
    ...
    return <div
        className="group relative bg-white/80 backdrop-blur-xl  border border-slate-200/60 rounded-2xl p-5 hover:border-slate-300/60 hover:shadow-xl transition-all duration-300 flex flex-col justify-between cursor-pointer hover:-translate-y-1  "
    ...
    >
        ...
        <div>
            <div className="flex items-start justify-between gap-3 mb-4">
                ...
                <button
                    ...
                    className="opacity-0 group-hover:opacity-100 w-8 h-8 flex items-center justify-center text-slate-400 hover:text-red-500 rounded-2xl transition-all duration-200"
                >
        ...
        {/* Hover Indicator */}
        <div className="absolute inset-0 rounded-2xl bg-linear-to-br from-emerald-500/0 to-teal-500/0 group-hover:bg-linear-to-br group-hover:from-emerald-500/10 group-hover:to-teal-500/10 transition-all duration-300 pointers-events-none" />
    </div>
